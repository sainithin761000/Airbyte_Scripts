#script usage - python3 create_destination.py ../config/destinations/postgres/postgres_destination.json
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python3 create_destination.py <config_file>")
        sys.exit(1)
